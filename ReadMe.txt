Step 1: Double Click on HMSTutorial.sln
Step2 : In the shared folder, copy the database file called "HMSdb.mdf" and paste it in your documents
...
SqlConnection Con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\afwadmin\Documents\HMSdb.mdf;Integrated Security=True;Connect Timeout=30");
